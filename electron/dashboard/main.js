 ...
 *  - Membuka jendela Dashboard Pegawai setelah server siap.
 *  - Mematikan server Laravel saat aplikasi ditutup.
 *
 * Entry URL: http://127.0.0.1:8000/pegawai/dashboard (read-only, tanpa login)
 */
...
function createWindow() {
    mainWindow = new BrowserWindow({
        ...
        minWidth:           1024,
        minHeight:          700,
        title:              'SIAPTIKA Dashboard Pegawai',
    ...
    // Muat halaman dashboard pegawai (read-only, tanpa login)
    mainWindow.loadURL(`${LARAVEL_URL}/pegawai/dashboard`);
...
function createSplashWindow() {
    ...
    splash.loadURL(`data:text/html;charset=utf-8,${encodeURIComponent(`
        ...
        <body>
            ...
            <div class="sub">Memuat Dashboard Pegawai...</div>
            <div class="loading">
                <div class="dot"></div>
                <div class="dot"></div>
                <div class="dot"></div>
